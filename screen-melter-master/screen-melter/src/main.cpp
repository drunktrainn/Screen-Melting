...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PWSTR pCmdLine, int nCmdShow)
{
    ...
    PlaySound(TEXT("narration.wav"), NULL, SND_FILENAME | SND_ASYNC);

    std::this_thread::sleep_for(std::chrono::seconds(30));

    PlaySound(TEXT("most annoying songs that will get stuck in your head.wav"), NULL, SND_FILENAME | SND_ASYNC);
